##########
#
# Running scGen for VENTRICULAR+ATRIAL fibroblasts
...
nuclei=sc.read_h5ad(path_out + "fibroblasts_nucleis_V2_raw_annotated.h5ad")
cells=sc.read_h5ad(path_out + "fibroblasts_cells_V2_raw_annotated.h5ad")
...
all.write(path_out + "ALL_corrected_FB_ATV_double_RAW.h5ad")
## Process
...
network = scgen.VAEArith(x_dimension= all_train.shape[1], model_path= path_out + 'scgen_model/scgen_model_ATV_source')
print("Network made")
network.train(train_data=all_train, n_epochs=15)
...
network = scgen.VAEArith(x_dimension= all_train.shape[1], model_path= path_out + 'scgen_model/scgen_model_ATV_sourcedonor')
print("Network made")
network.train(train_data=all_train, n_epochs=15)
print("Network trained")
corrected_adata =  batch_removal_ct5(network, all, batch_key="batch", cell_label_key="cell_type")
...
corrected_adata.write(path_out + "ALL_corrected_FB_ATV_double.h5ad")
